...
import 'package:meuni_mobile/ui/views/login/login_viewmodel.dart';
...
final Map<String, String? Function(String?)?> _LoginViewTextValidations = {
  UsernameValueKey: LoginValidators.validateUsername,
  PasswordValueKey: LoginValidators.validatePassword,
};
